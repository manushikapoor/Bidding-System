...
import static com.manushi.bidding.util.Constants.BIDDING_SERVICE;
import static com.manushi.bidding.util.Constants.ERROR_CODE_DATABASE_EXCEPTION;
import static com.manushi.bidding.util.Constants.ERROR_CODE_DATA_NOT_FOUND_EXCEPTION;
...
import static com.manushi.bidding.util.Constants.LOG_PATTERN;
...
import com.manushi.bidding.repository.enums.ExceptionType;
...
public class CustomExceptionsHandler {
	...
	public final ResponseEntity<ErrorVO> handleRabbitMqException(RabbitMqException ex) {
		log.info(LOG_PATTERN, BIDDING_SERVICE, ExceptionType.INTERNAL_SERVER_ERROR, ERROR_CODE_INTERNAL_SERVER_EXCEPTION, ex);
		return ResponseEntity.internalServerError()
				.body(buildErrorResponse(new RabbitMqException(ex.getMessage()), ERROR_CODE_INTERNAL_SERVER_EXCEPTION));
	}
	...
	public final ResponseEntity<ErrorVO> handleDataAccessException(Exception ex) {
		log.error(LOG_PATTERN, BIDDING_SERVICE, ExceptionType.DATABASE_ERROR, ERROR_CODE_DATABASE_EXCEPTION, ex);
		return ResponseEntity.internalServerError()
	...
	public final ResponseEntity<ErrorVO> handleException(Throwable ex, HttpServletRequest request) {
		log.error(LOG_PATTERN, BIDDING_SERVICE, ExceptionType.INTERNAL_SERVER_ERROR, ERROR_CODE_INTERNAL_SERVER_EXCEPTION, ex);
